...
# Standard image
set fmri(regstandard) "/jukebox/pkgs/FSL/5.0.9/data/standard/MNI152_T1_2mm_brain"
...
set fmri(paradigm_hp) 140

# Total voxels
set fmri(totalVoxels) 195194880
...
set feat_files(1) "###INPUTDIR###"

# Add confound EVs text file
set fmri(confoundevs) 0

# Subject's structural image for analysis 1
set highres_files(1) "###ANATDIR###"
